...
project = 'ihm-molstar-mvs'
copyright = ("2025, Berkeley MSSE: Patrick Neal, Cynthia Perez, and Sahil Patil. Project structure based on the "
             "Computational Molecular Science Python Cookiecutter version 1.10")
author = 'Berkeley MSSE: Patrick Neal, Cynthia Perez, and Sahil Patil'
